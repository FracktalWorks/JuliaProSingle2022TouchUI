...
plugin_identifier = "JuliaProSingle2022TouchUI"

# The plugin's python package, should be "octoprint_<plugin identifier>", has to be unique
plugin_package = "octoprint_JuliaProSingle2022TouchUI"

# The plugin's human readable name. Can be overwritten within OctoPrint's internal data via __plugin_name__ in the
# plugin module
plugin_name = "Octoprint-JuliaProSingle2022TouchUI"
...
# module
plugin_description = """TouchScreen Plugin for Julia Pro Single ABL based on Python3 and PyQt5"""
...
plugin_url = "https://github.com/FracktalWorks/JuliaProSingl2022TouchUI"
